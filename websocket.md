...
let start = function (wsData) {
  ...
  var wsUrl
  // 与服务器建立连接的地址
  if (wsData.env === 'online') {
    wsUrl = 'ws://websocket-internal.pulse.vipkid.com.cn/websocket'
  } else if (wsData.env === 'pre') {
    wsUrl = 'ws://pre-websocket-internal.pulse.vipkid.com.cn/websocket'
  } else {
    wsUrl = 'ws://websocket.pulse.vipkid-qa.com.cn/websocket'
  }
